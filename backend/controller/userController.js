...
const login = async (req, res, next) => {
  try {
    ...
    if (isMatch) {
      var keycloaktoken = "";
      const keycloakURL = 'http://keycloak:8080/auth/realms/spring/protocol/openid-connect/token';
      const clientId = 'spring-client';
      const clientSecret = 'eleOb1VUqoufZWCipuwTM7d9Wyf50GKq';
      ...
      await axios({
        ...
        .catch((error) => {
          ...
          return res.status(401).json({
            message: "Error logging in keycloak",
